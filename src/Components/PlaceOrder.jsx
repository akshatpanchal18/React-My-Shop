...
function PlaceOrder() {
  const {shipping_fee,oneProduct } = useCartContaxt();
//   const total = (Number(shipping_fee) + Number(product.price) || 0).toFixed(2)
  //-------------------------------------------------------
          ...
          <div className="checkout-column item-details">
            ...
            {oneProduct.map((product) => (
              <div className="item" key={product.id}>
                ...
                <p>
                <strong>Total:</strong> $
                {(shipping_fee+(product.amount*product.price)).toFixed(2)}
              </p>
              </div>
            ))}
